...
func init() {
	...
	proto.RegisterType((*HelloReply)(nil), "routeguide.HelloReply")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x2a, 0xca, 0x2f, 0x2d, 0x49, 0x4d, 0x2f,
	0xcd, 0x4c, 0x49, 0x55, 0x52, 0xe2, 0xe2, 0xf1, 0x00, 0x49, 0x05, 0xa5, 0x16, 0x96, 0xa6, 0x16,
	...
	0x81, 0x5d, 0x6a, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x5c, 0xba, 0x28, 0x69, 0xb8, 0x00, 0x00,
	0x00,
}
...
type GreeterClient interface {
	// Sends a greeting
	ß(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/routeguide.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/routeguide.Greeter/SayHello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "routeguide.Greeter",
